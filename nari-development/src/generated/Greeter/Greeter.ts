...
export class GreetingChanged extends ethereum.Event {
  get params(): GreetingChanged__Params {
    return new GreetingChanged__Params(this);
  }
}

export class GreetingChanged__Params {
  _event: GreetingChanged;

  constructor(event: GreetingChanged) {
    this._event = event;
  }
